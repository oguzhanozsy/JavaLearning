    ...
    public void hareketYap(String hareketTuru , int sayi){
        ...
        public void burpeeYap(int sayi) {
            ...
            if(burpee_sayisi - sayi < 0){
                ...
                System.out.println("Hedeflediğin burpeeyi geçtin.TEBRİKLER!");
                burpee_sayisi = 0;
        ...
        public void pushupYap(int sayi) {
            ...
            if(pushup_sayisi - sayi < 0){
                ...
                System.out.println("Hedeflediğin pushUpı geçtin.TEBRİKLER!");
                pushup_sayisi = 0;
        ...
        public void sitYap(int sayi) {
            ...
            if(situp_sayisi - sayi < 0){
                ...
                System.out.println("Hedeflediğin sitUpı geçtin.TEBRİKLER!");
                situp_sayisi = 0;
        ...
        public void squatYap(int sayi) {
            ...
            if(squat_sayisi - sayi < 0){
                ...
                System.out.println("Hedeflediğin squatı geçtin.TEBRİKLER!");
                squat_sayisi = 0;
